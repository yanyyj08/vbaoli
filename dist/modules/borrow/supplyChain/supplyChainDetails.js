...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/b303980212a1fe02938d7b2dee06fbbf', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/b303980212a1fe02938d7b2dee06fbbf',undefined,undefined)
	...
	module.exports = {
	    data: function () {return {
	        ...
	        tabItems: [{
	            ...
	            title: '明星优选介绍',
	            icon: '',
	            src: 'modules/borrow/supplyChain/supplyChainIntro.js',
	            titleColor: '',
	            display: 'block'
	        }, {
	            index: 1,
	            title: '项目详情',
	            icon: '',
	            src: 'modules/borrow/supplyChain/supplyChainInfo.js',
	            titleColor: '',
	            display: 'none'
	        }, {
	            index: 2,
	            title: '加入记录',
	            icon: '',
	            src: 'modules/borrow/supplyChain/supplyChainJoin.js',
	            titleColor: '',
	            display: 'none'
	        }, {
	            index: 3,
	            title: '常见问题',
	            icon: '',
	            src: 'modules/borrow/supplyChain/supplyChainQ.js',
	            titleColor: '',
	            display: 'none'
	        }]
	    }}
